                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-12">
                            <div class="form-group" style="margin-bottom: 0%">
                                <div class="col-md-5">
                                    <label class="control-label"><b>NOMBRE ESTUDIANTE</b></label>
                                    <input type="text" class="form-control"
                                           value="<?= $datos_cliente->estudiante ?>" readonly/>
                                </div>
                                <div class="col-md-2">
                                    <label class="control-label"><b>CÉDULA IDENTIDAD</b></label>
                                    <input class="form-control" readonly
                                           value="<?= $datos_cliente->ci_estudiante ?>">
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-2">
                                    <label class="control-label"><b>MONTO TOTAL</b></label>
                                    <input class="form-control" readonly
                                           value="<?= $datos_cliente->monto ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="table table-responsive">
                                    <table id="lista_datos" class="table table-bordered">
                                        ...
                                        <th style="width: 25%" class="text-center">FORMA PAGO</th>
                                        <th style="width: 22%" class="text-center">FECHA PAGO</th>
                                        <th style="width: 20%" class="text-center">CUOTA</th>
                                        <th style="width: 27%" class="text-center">ESTADO</th>
