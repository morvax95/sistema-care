            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    ...
                    <input type="text" class="form-control" id="ci" name="ci"
                           value="<?= isset($persona) ? $persona->ci : '' ?>"
                           placeholder="Campo requerido" required readonly/>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input type="text" id="telefono" name="telefono" class="form-control"
                           ...
                           placeholder="Campo no requerido" readonly/>
                </div>
            </div>
            <div class="form-group">
        ...
        <div class="box-body">
            ...
            <div class="box-body">
                <div class="form-group" id="div_mensaje_adm">
                    <center><p style="margin-left: 5%">Para los administradores no es necesaria la selección de
                            funciones.</p></center>
